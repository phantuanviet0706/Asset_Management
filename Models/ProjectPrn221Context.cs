...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Assets__3213E83FBB80ECA3");
            ...
            entity.HasOne(d => d.Assignee).WithMany(p => p.AssetAssignees)
                ...
                .HasConstraintName("FK__Assets__assignee__30F848ED");

            entity.HasOne(d => d.CreateByUserNavigation).WithMany(p => p.AssetCreateByUserNavigations)
                .HasForeignKey(d => d.CreateByUser)
                .HasConstraintName("FK__Assets__create_b__32E0915F");

            entity.HasOne(d => d.Location).WithMany(p => p.Assets)
                .HasForeignKey(d => d.LocationId)
                .HasConstraintName("FK__Assets__location__2F10007B");

            entity.HasOne(d => d.Status).WithMany(p => p.Assets)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Assets__status_i__300424B4");

            entity.HasOne(d => d.Type).WithMany(p => p.Assets)
                .HasForeignKey(d => d.TypeId)
                .HasConstraintName("FK__Assets__type_id__2E1BDC42");

            entity.HasOne(d => d.Vendor).WithMany(p => p.Assets)
                .HasForeignKey(d => d.VendorId)
                .HasConstraintName("FK__Assets__vendor_i__31EC6D26");
        });

        modelBuilder.Entity<Locations>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetLoc__3213E83F927C643C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetSta__3213E83F89186D36");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetTra__3213E83F48E3B244");
            ...
            entity.HasOne(d => d.Asset).WithMany(p => p.AssetTransactions)
                ...
                .HasConstraintName("FK__AssetTran__asset__35BCFE0A");
        });

        modelBuilder.Entity<Types>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetTyp__3213E83F1BAF2366");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetVen__3213E83FAE17DF64");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3213E83F4216C162");
